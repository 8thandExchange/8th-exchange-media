...
const SECTIONS = [
  ...
  },
  {
    ...
    list: [
      ...
      "If you allow analytics cookies, we load Google Analytics 4 and the Meta Pixel to measure marketing. Those scripts do not load on the staff dashboard, client portal, or payment pages, and they do not load if you decline.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      "We use trusted third-party providers to operate the site and business, including hosting (Vercel), email delivery (Resend), payments (Stripe), and — only if you allow analytics cookies — Google Analytics and Meta (Facebook/Instagram) for advertising measurement. These providers process data on our behalf under their own privacy terms and applicable agreements.",
    ],
  },
  {
  ...
  },
  {
    title: "Your choices",
    paragraphs: [
      `You may request access, correction, or deletion of personal information we hold by contacting ${CONTACT_EMAIL}. You may opt out of non-essential marketing messages at any time. Analytics cookies can be declined on the consent banner; clearing site data for 8emedia.com will prompt the choice again.`,
    ],
  },
  {
    title: "Contact",
