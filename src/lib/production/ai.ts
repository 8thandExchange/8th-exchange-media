...
export async function refineProductionScript(
  ...
  try {
    const result = await generateText({
      ...
      system: [
        "You are a senior commercial director and script editor for 8th & Exchange Media.",
        "Write spoken copy that a confident presenter can say without sounding like software.",
        "On-screen copy must be short enough to typeset on a finished card.",
        ...
        "Do not mention audits, scores, crawlers, or internal process.",
